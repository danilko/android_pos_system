...
public class ProductListViewActivity extends Activity
{
    ...
    ProductListViewAdapter mLineItemAdapter;
    ...
    boolean mInputUser = false;
    
    boolean mCompletedOrder = false;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        ListView lListView = (ListView)findViewById(R.id.main_listview_list);
        
        mLineItemAdapter = new ProductListViewAdapter(this, mCursor);
        lListView.setAdapter(mLineItemAdapter);
      
        EditText lEditText = (EditText)findViewById(R.id.main_listview_edittext_search);
        lEditText.addTextChangedListener(new TextWatcher()
        {
            ...
            public void onTextChanged(CharSequence pCharSequence, int arg1, int arg2,
                    int arg3)
            {
                mLineItemAdapter.getFilter().filter(pCharSequence.toString().trim());
            }
            
        });
        
        mLineItemAdapter.setFilterQueryProvider(new FilterQueryProvider()
        {
    ...
    public boolean onOptionsItemSelected(MenuItem pItem)
    {
        switch (pItem.getItemId())
        {
            case R.id.menu_item_changedisplay:
                Intent lIntentGridView = new Intent(this, ProductGridViewActivity.class);
    ...
    {
        if(mCompletedOrder == false)
        {
            Toast toast = Toast.makeText(this, R.string.no_order, Toast.LENGTH_SHORT);
            toast.show();
            return;
        }  // if
        
        LayoutInflater factory = LayoutInflater.from(this);
        final View textEntryView = factory.inflate(R.layout.dialog_completed_order, null);
          
        AlertDialog.Builder lDialog = new AlertDialog.Builder(this);
        lDialog.setTitle(R.string.dialog_completed_order_title);
        lDialog.setView(textEntryView);
        
        lDialog.setPositiveButton("OK", new DialogInterface.OnClickListener()
        {
    ...
    public void inputuser()
    {
        ...
        final View textEntryView1 = factory.inflate(R.layout.dialog_customer_information, null);
        
        AlertDialog.Builder lDialog = new AlertDialog.Builder(this);
        lDialog.setTitle(R.string.dialog_cusomter_information_title);
        lDialog.setView(textEntryView1);
